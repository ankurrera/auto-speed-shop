...
const supabaseAnonKey = process.env.VITE_SUPABASE_PUBLISHABLE_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRrb3BvaHFpaWhoeG1iamh6YXJrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU2NzE2NDMsImV4cCI6MjA3MTI0NzY0M30.6EF5ivhFPmK5B7Y_zLY-FkbN3LHAglvRHW7U0U5LoXA";
...
async function createAdminUser() {
  ...
  try {
    ...
    const { data: signUpData, error: signUpError } = await supabase.auth.signUp({
      ...
      password: ADMIN_PASS,
      options: {
        emailRedirectTo: `${process.env.SITE_URL || 'http://localhost:8080'}/`,
        data: { 
          first_name: 'Admin', 
          last_name: 'User',
          phone: '555-0123'
...
async function testEmailNotifications(product, part) {
  ...
  try {
    ...
    // Test part notification
    console.log('📤 Testing part notification...');
