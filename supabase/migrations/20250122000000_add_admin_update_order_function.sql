...
BEGIN
  ...
  SET 
    convenience_fee = COALESCE(convenience_fee_param, convenience_fee),
    delivery_charge = COALESCE(delivery_charge_param, delivery_charge),
    tax_amount = COALESCE(tax_amount_param, tax_amount),
    total_amount = COALESCE(total_amount_param, total_amount),
    status = 'invoice_sent',
