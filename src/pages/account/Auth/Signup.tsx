...
export const Signup = ({ 
  ...
  const handleSignup = async (e: FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        while (!profileCreated && retryCount < maxRetries) {
          try {
            ...
            console.error(`Profile creation attempt ${retryCount + 1} error:`, profileCreationError);
        ...
        // If admin signup, offer to create seller account
      ...
      alert("Account creation failed: " + (signupError.message || "Unknown error"));
    }
  };
