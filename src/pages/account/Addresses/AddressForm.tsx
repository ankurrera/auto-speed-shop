...
interface AddressFormProps {
  ...
  onFormAddressChange: (address: AddressFormType) => void;
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  onFormAddressChange({ ...formAddress, city: e.target.value })
                }
                required
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  onFormAddressChange({ ...formAddress, state: e.target.value })
                }
                required
              />
            </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                onFormAddressChange({ ...formAddress, phone: e.target.value })
              }
              required
            />
          </div>
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                onFormAddressChange({ ...formAddress, is_default: !!checked })
              }
            />
