...
interface AddressManagementProps {
  ...
  onSubmitAddressForm: (e: React.FormEvent) => void;
  onResetForm: () => void;
}
              ...
              <Card key={address.id}>
                ...
                <CardContent>
                  ...
                  <div className="flex space-x-2 mt-4">
                    <Button variant="outline" size="sm" onClick={() => onEditAddress(address)}>Edit</Button>
                    <Button variant="outline" size="sm" onClick={() => onDeleteAddress(address.id!)}>Delete</Button>
                    {!address.is_default && (
                      <Button variant="secondary" size="sm" onClick={() => onSetDefaultAddress(address.id!)}>Set as Default</Button>
                    )}
                  </div>
                </CardContent>
              </Card>
